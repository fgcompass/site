...
![Framework model for the decision trees](images/fgcompass-dt-model.png){#fig-dt-model width="550"}
...
![Decision tree for Throwing](images/fgcompass-dt-man-ot.png){#fig-dt-throw width="550"}
