...
The Child Observational Movement Pattern Assessment System[^1] (FG-COMPASS) is an assessment tool designed to evaluate the proficiency of fundamental movement skills in children between the ages of 5 to 10. It can be utilized in both educational and clinical environments.

[^1]: Formally know as "Computerized Observational Movement Pattern Assessment System".
...
![Framework model for the decision trees](images/fgcompass-dt-model.png){#fig-dt-model width="750"}
...
![Decision tree for Throwing](images/fgcompass-dt-man-ot.png){#fig-dt-throw width="750"}
